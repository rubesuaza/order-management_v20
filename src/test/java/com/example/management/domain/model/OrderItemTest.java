...
class OrderItemTest {
    ...
    void shouldCalculateTotalPriceCorrectly() {
        ...
        OrderItem item = new OrderItem("PROD-001", unitPrice, quantity);
    ...
    void shouldThrowExceptionWhenProductIdIsEmpty() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem("", unitPrice, quantity);
        });
    }
    ...
    void shouldThrowExceptionWhenUnitPriceIsNull() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem("PROD-001", null, quantity);
        });
    }
    ...
    void shouldThrowExceptionWhenQuantityIsNull() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new OrderItem("PROD-001", unitPrice, null);
        });
    }

    @Test
    void shouldBeEqualWhenAllFieldsAreSame() {
        OrderItem item1 = new OrderItem("PROD-001", new Money(10.50), new Quantity(2));
        OrderItem item2 = new OrderItem("PROD-001", new Money(10.50), new Quantity(2));
    ...
    void shouldNotBeEqualWhenProductIdIsDifferent() {
        OrderItem item1 = new OrderItem("PROD-001", new Money(10.50), new Quantity(2));
        OrderItem item2 = new OrderItem("PROD-002", new Money(10.50), new Quantity(2));
